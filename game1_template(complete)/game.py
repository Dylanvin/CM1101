...
def exit_leads_to(exits, direction):
    ...
    'Reception'
    """
    exit_leads_to = exits[direction]
    room_name=rooms[exit_leads_to]
    exit_leads_to=room_name["name"]
    return exit_leads_to
...
def main():
    ...
    while True:
        ...
        display_room(current_room)#DONE
